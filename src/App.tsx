  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900 font-sans selection:bg-stone-200">
      ...
      <a
        ...
        className="fixed bottom-56 right-4 z-50 bg-emerald-600 text-white p-3 rounded-full shadow-2xl shadow-emerald-600/40 hover:scale-105 transition-transform flex items-center gap-2"
      >
